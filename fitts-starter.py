...
def calculate_fitts(distance, width, use_a, use_b):
    ...
    get_index_difficulty = calculate_index_difficulty(distance, width)
    return use_a + (use_b * get_index_difficulty)
...
def calculate_index_difficulty(distance, width):
    ...
    calc_id = math.log2((distance/width) + 1) 
    return calc_id
...
ui.markdown("Edited by Joseph Bison")
